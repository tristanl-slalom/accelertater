...
class TestDadJokeRepository:
    ...
    async def test_get_random_joke_success(self, repository: DadJokeRepository) -> None:
        ...
        mock_response = Mock()
        mock_response.json.return_value = {"joke": "Why did the chicken cross the road?"}
    ...
    @pytest.mark.asyncio
    async def test_get_random_joke_request_error(self, repository: DadJokeRepository) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_random_joke_http_error(self, repository: DadJokeRepository) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_random_joke_json_missing_joke(self, repository: DadJokeRepository) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_random_joke_unexpected_error(self, repository: DadJokeRepository) -> None:
